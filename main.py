...
with st.expander("⚙️ Параметры генерации", expanded=False):
    ...
    ### Текущие настройки
    - **Temperature**: 0.3
      - Низкая температура обеспечивает более сфокусированные и последовательные ответы
      - Помогает консультанту придерживаться заданной роли
    
    - **Top P**: 0.95
      - Высокое значение для естественных, но контролируемых ответов
      - Позволяет сохранять креативность в рамках заданных ограничений
    
    - **Frequency Penalty**: 0.2
      - Легкий штраф для избежания повторений
      - Обеспечивает разнообразие формулировок
    
    - **Presence Penalty**: 0.2
      - Легкий штраф для поддержания контекста
      - Помогает сохранять последовательность диалога
    """)
